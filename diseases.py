DISEASE_DATABASE = {
    ...
    'Apple___Black_rot': {
        ...
        'treatment': 'Prune infected branches, apply fungicides, and remove affected fruit.'
    },
    'Apple___Cedar_apple_rust': {
        ...
        'treatment': 'Use resistant apple varieties, apply fungicides, and remove nearby juniper hosts.'
    },
    'Apple___healthy': {
        'name': 'Healthy Apple',
        'description': 'No disease detected. The apple tree is in good health.',
        'symptoms': 'No visible symptoms.',
        'treatment': 'Maintain proper care, watering, and fertilization for continued health.'
    },
    'Blueberry___healthy': {
        'name': 'Healthy Blueberry',
        'description': 'No disease detected. The blueberry plant is in good health.',
        'symptoms': 'No visible symptoms.',
        'treatment': 'Continue proper watering, pruning, and fertilization for healthy growth.'
    },
    'Cherry_(including_sour)___Powdery_mildew': {
        ...
        'treatment': 'Apply fungicides, prune for air circulation, and remove infected leaves.'
    },
    'Cherry_(including_sour)___healthy': {
        'name': 'Healthy Cherry',
        'description': 'No disease detected. The cherry tree is in good health.',
        'symptoms': 'No visible symptoms.',
        'treatment': 'Maintain proper watering, pruning, and fertilization for continued health.'
    },
    'Corn_(maize)___Cercospora_leaf_spot Gray_leaf_spot': {
        ...
        'treatment': 'Rotate crops, apply fungicides, and use resistant varieties.'
    },
    'Corn_(maize)___Common_rust_': {
        ...
        'treatment': 'Use resistant hybrids, apply fungicides, and ensure good air circulation.'
    },
    'Corn_(maize)___Northern_Leaf_Blight': {
        ...
        'treatment': 'Use resistant varieties, apply fungicides, and rotate crops.'
    },
    'Corn_(maize)___healthy': {
        'name': 'Healthy Corn',
        'description': 'No disease detected. The corn plant is in good health.',
        'symptoms': 'No visible symptoms.',
        'treatment': 'Maintain proper watering, fertilization, and pest management for continued health.'
    },
    'Grape___Black_rot': {
    ...
    'Grape___Esca_(Black_Measles)': {
        ...
        'treatment': 'Remove infected wood, apply fungicides, and use proper irrigation techniques.'
    },
    'Grape___Leaf_blight_(Isariopsis_Leaf_Spot)': {
        ...
        'treatment': 'Apply fungicides, prune affected areas, and ensure good air circulation.'
    },
    'Grape___healthy': {
        'name': 'Healthy Grape',
        'description': 'No disease detected. The grapevine is in good health.',
        'symptoms': 'No visible symptoms.',
        'treatment': 'Maintain proper pruning, watering, and disease prevention practices for continued health.'
    },
    'Orange___Haunglongbing_(Citrus_greening)': {
        ...
        'treatment': 'Control psyllid populations, remove infected trees, and use resistant varieties.'
    },
    'Peach___Bacterial_spot': {
        ...
        'treatment': 'Use resistant varieties, apply copper-based sprays, and prune infected areas.'
    },
    'Peach___healthy': {
        'name': 'Healthy Peach',
    ...
    'Pepper,_bell___Bacterial_spot': {
        ...
        'treatment': 'Use resistant varieties, apply copper-based sprays, and avoid overhead watering.'
    },
    ...
    'Potato___Early_blight': {
        ...
        'treatment': 'Rotate crops, apply fungicides, and remove infected plant debris.'
    },
    ...
    'Potato___healthy': {
        ...
        'symptoms': 'No visible symptoms.',
        'treatment': 'Maintain proper irrigation, soil health, and disease prevention strategies.'
    },
     'Raspberry___healthy': {
        'name': 'Healthy Raspberry',
        'description': 'No disease detected. The raspberry plant is in good health.',
        'symptoms': 'No visible symptoms.',
        'treatment': 'Maintain proper watering, fertilization, and pruning for continued health.'
    },
    'Soybean___healthy': {
        'name': 'Healthy Soybean',
        'description': 'No disease detected. The soybean plant is in good health.',
        'symptoms': 'No visible symptoms.',
        'treatment': 'Ensure proper irrigation, fertilization, and pest management for continued health.'
    },
    'Squash___Powdery_mildew': {
        ...
        'treatment': 'Apply fungicides, prune for air circulation, and avoid overhead watering.'
    },
    ...
    'Strawberry___healthy': {
        ...
        'symptoms': 'No visible symptoms.',
        'treatment': 'Maintain proper watering, fertilization, and disease prevention for continued health.'
    },
    ...
    'Tomato___Leaf_Mold': {
        ...
        'treatment': 'Improve ventilation, use fungicides, and remove infected leaves.'
    },
    ...
    'Tomato___Spider_mites Two-spotted_spider_mite': {
        ...
        'treatment': 'Use insecticidal soap, neem oil, and encourage natural predators like ladybugs.'
    },
    'Tomato___Target_Spot': {
        ...
        'treatment': 'Apply fungicides, remove infected plant debris, and improve air circulation.'
    },
    ...
    'Tomato___Tomato_mosaic_virus': {
        ...
        'treatment': 'Use resistant varieties, sanitize tools, and remove infected plants.'
    },
    'Tomato___healthy': {
        'name': 'Healthy Tomato',
        'description': 'No disease detected. The tomato plant is in good health.',
        'symptoms': 'No visible symptoms.',
        'treatment': 'Maintain proper watering, fertilization, and pest control for continued health.'
    }
}
